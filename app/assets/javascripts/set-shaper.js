	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: '/users/sign_out', className: 'btn btn-default vcenter', style: { float: 'right', marginTop: '40px' }, 'data-method': 'delete' },
	          'Log Out'
	        ),
	        _react2.default.createElement(
	          'h1',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'div',
	                { role: 'tabpanel', className: 'tab-pane', id: 'mySetsBottom' },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReactTransitionGroup = __webpack_require__(1017);
	var ReactCSSTransitionGroupChild = __webpack_require__(1020);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(301);
	var ReactTransitionChildMapping = __webpack_require__(1018);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var flattenChildren = __webpack_require__(1019);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(301);
	var ReactAddonsDOMDependencies = __webpack_require__(1021);

	var propTypesFactory = __webpack_require__(328);
	var PropTypes = propTypesFactory(React.isValidElement);

	var CSSCore = __webpack_require__(1027);
	var ReactTransitionEvents = __webpack_require__(1028);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  exports.getReactPerf = function () {
	    if (!ReactPerf) {
	      ReactPerf = __webpack_require__(1022);
	    }
	    return ReactPerf;
	  };
	  ...
	  exports.getReactTestUtils = function () {
	    if (!ReactTestUtils) {
	      ReactTestUtils = __webpack_require__(1024);
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var lowPriorityWarning = __webpack_require__(1023);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(1025);
	...
	var ReactShallowRenderer = __webpack_require__(1026);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _set_table = __webpack_require__(1030);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, _ref3) {
	  ...
	  return {
	    onSetClick: function onSetClick(setId) {
	      dispatch((0, _actions.select)(setId, selectionType));
	      dispatch((0, _actions.fetchSetAndMaterials)(setId));
	    }
	  };
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _biomaterial_table = __webpack_require__(1032);

	var _droppable = __webpack_require__(1033);

	var _droppable2 = _interopRequireDefault(_droppable);

	var _item_types = __webpack_require__(1034);
	...
	var setTarget = {
	  drop: function drop(props, monitor, component) {
	    ...
	    return dispatch((0, _actions.fetchTokenIfNeeded)()).then(function () {
	...
	var mapStateToProps = function mapStateToProps(state) {
	  return {
	    biomaterials: (0, _selectors.getSelectedTopMaterials)(state),
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	  return {
	    onRemove: function onRemove(biomaterial) {
	      ...
	      dispatch((0, _actions.fetchTokenIfNeeded)()).then(function () {
	        return dispatch((0, _reduxJsonApi.updateEntity)(entity));
	      }).then(function () {
	        return dispatch((0, _reduxJsonApi.readEndpoint)('sets/' + set.id + '?include=materials'));
	      });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reselect = __webpack_require__(1036);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _draggable_selected_collection = __webpack_require__(1040);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactOnclickoutside = __webpack_require__(1041);

	var _reactOnclickoutside2 = _interopRequireDefault(_reactOnclickoutside);

	var _draggable = __webpack_require__(1042);
	...
	var mapStateToProps = function mapStateToProps(state) {
	  return {
	    biomaterials: (0, _selectors.getSelectedBottomMaterials)(state),
	    materials: state.materials,
	...
	var Wrapper = (0, _reactOnclickoutside2.default)(_react2.default.createClass({
	  ...
	  onClick: function onClick(biomaterial, index, evt) {
	    ...
	    dispatch((0, _actions.storeItems)(biomaterials));

	    if (evt.metaKey) {
	      dispatch((0, _actions.toggleItem)(index));
	    } else if (evt.shiftKey) {
	      dispatch((0, _actions.shiftSelectItems)(index));
	    } else {
